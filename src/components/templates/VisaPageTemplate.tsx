...
@media (max-width: 1024px) {
  ...
  .visa-right {
    transform: none; /* the desktop-only 154px offset would push the image off-screen below 1024px */
    width: 100%;
    max-width: 560px;
    margin: 0 auto;
  }
...
@media (max-width: 640px) {
  ...
  /* Make the hero photo noticeably smaller and centered on phones, instead
     of stretching edge-to-edge like it was before */
  .visa-right {
    max-width: 300px;
    margin: 0 auto;
  }
...
@media (max-width: 1024px) {
  ...
  .stories-grid { grid-template-columns: repeat(2, 1fr); }
  .story-card:nth-child(3) { display: none; } /* Hide 3rd on tablet */
  .comp-section { padding: 48px 20px 64px; }
  .comp-container { padding: 36px 28px; }
}

@media (max-width: 640px) {
  .comp-section { padding: 40px 16px 56px; gap: 24px; }
  .comp-container { padding: 28px 18px; border-radius: 18px; }
  .comp-header { margin-bottom: 28px; }
  .wcu-grid { grid-template-columns: 1fr 1fr; gap: 14px; }
  .wcu-card { padding: 22px 12px; }
  .wcu-card-title { font-size: 13.5px; }
  .wcu-card-desc { font-size: 11.5px; }
  .stories-grid { grid-template-columns: 1fr; }
  .story-card:nth-child(2) { display: none; } /* Hide 2nd on mobile */
  .nav-arrow { display: none; } /* Hide arrows on mobile to save space */
  .faq-col-header { font-size: 20px; }
}
/* ---------------------------- DREAM REALITY CTA SECTION --------------------------- */
.dream-section {
  width: 100%;
...
/* Stagger the eligibility, documents, why-choose-us & story cards the same way */
.elig-grid > .elig-card:nth-child(1),
.docs-grid > .docs-card:nth-child(1),
.wcu-grid > .wcu-card:nth-child(1),
.stories-grid > .story-card:nth-child(1),
.process-wrapper > .process-card:nth-child(1) { animation-delay: 0.05s; }

.elig-grid > .elig-card:nth-child(2),
.docs-grid > .docs-card:nth-child(2),
.wcu-grid > .wcu-card:nth-child(2),
.stories-grid > .story-card:nth-child(2),
.process-wrapper > .process-card:nth-child(2) { animation-delay: 0.12s; }

.elig-grid > .elig-card:nth-child(3),
.docs-grid > .docs-card:nth-child(3),
.wcu-grid > .wcu-card:nth-child(3),
.stories-grid > .story-card:nth-child(3),
.process-wrapper > .process-card:nth-child(3) { animation-delay: 0.19s; }

.elig-grid > .elig-card:nth-child(4),
.docs-grid > .docs-card:nth-child(4),
.wcu-grid > .wcu-card:nth-child(4),
.process-wrapper > .process-card:nth-child(4) { animation-delay: 0.26s; }

.elig-grid > .elig-card:nth-child(5),
.docs-grid > .docs-card:nth-child(5),
.wcu-grid > .wcu-card:nth-child(5),
.process-wrapper > .process-card:nth-child(5) { animation-delay: 0.33s; }

.elig-grid > .elig-card:nth-child(6),
.docs-grid > .docs-card:nth-child(6),
.wcu-grid > .wcu-card:nth-child(6) { animation-delay: 0.4s; }

.docs-grid > .docs-card:nth-child(7) { animation-delay: 0.47s; }
.docs-grid > .docs-card:nth-child(8) { animation-delay: 0.54s; }

/* Gentle floating motion for the hero success-rate card on larger screens, and a
   subtle "breathing" badge for extra life on the page without being distracting */
...
/* Tap feedback for touch devices — hover states don't fire on tap, so give
   cards, buttons and the process steps a quick "press" animation instead */
...
<h1 className="visa-title">
                ...
                <div className="visa-buttons">
                  <a href="/free-assessment" className="visa-btn visa-btn-primary">
                    Apply Now <ArrowRight size={18} />
                  </a>

                  <a href="#faq" className="visa-btn visa-btn-secondary">
                    Free Assessment <ArrowRight size={18} />
                  </a>
                </div>             
                   <div className="visa-social-proof">
